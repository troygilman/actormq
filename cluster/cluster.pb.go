...
var file_cluster_proto_rawDesc = []byte{
	...
	0x07, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x22, 0x43, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x24, 0x0a, 0x0d, 0x74, 0x79, 0x70, 0x65, 0x4e,
	0x61, 0x6d, 0x65, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d,
	0x74, 0x79, 0x70, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x22, 0x59, 0x0a,
	0x0d, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x18,
	...
	0x69, 0x72, 0x65, 0x63, 0x74, 0x50, 0x49, 0x44, 0x22, 0x4a, 0x0a, 0x08, 0x4c, 0x6f, 0x67, 0x45,
	...
	0x74, 0x65, 0x72, 0x2e, 0x50, 0x49, 0x44, 0x52, 0x05, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x42, 0x28,
	0x5a, 0x26, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x72, 0x6f,
...
var file_cluster_proto_goTypes = []any{
	...
	(*MessageResult)(nil),       // 1: cluster.MessageResult
	(*LogEntry)(nil),            // 2: cluster.LogEntry
	(*AppendEntries)(nil),       // 3: cluster.AppendEntries
	(*AppendEntriesResult)(nil), // 4: cluster.AppendEntriesResult
	(*RequestVote)(nil),         // 5: cluster.RequestVote
	(*RequestVoteResult)(nil),   // 6: cluster.RequestVoteResult
	(*PID)(nil),                 // 7: cluster.PID
	(*RegisterNode)(nil),        // 8: cluster.RegisterNode
	(*ActiveNodes)(nil),         // 9: cluster.ActiveNodes
}
var file_cluster_proto_depIdxs = []int32{
	7, // 0: cluster.MessageResult.redirectPID:type_name -> cluster.PID
	0, // 1: cluster.LogEntry.message:type_name -> cluster.Message
	2, // 2: cluster.AppendEntries.entries:type_name -> cluster.LogEntry
	7, // 3: cluster.ActiveNodes.nodes:type_name -> cluster.PID
