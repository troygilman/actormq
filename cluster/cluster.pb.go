...
func (x *MessageResult) GetRedirectPID() *PID {
	if x != nil {
...
var file_cluster_proto_rawDesc = []byte{
	...
	0x07, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x22, 0x59, 0x0a, 0x15, 0x4d, 0x65, 0x73, 0x73,
	...
	0x61, 0x6d, 0x65, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x22, 0x59, 0x0a, 0x0d, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x63,
	0x63, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x12, 0x2e, 0x0a, 0x0b, 0x72, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x50,
	0x49, 0x44, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x63, 0x6c, 0x75, 0x73, 0x74,
	0x65, 0x72, 0x2e, 0x50, 0x49, 0x44, 0x52, 0x0b, 0x72, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74,
	0x50, 0x49, 0x44, 0x22, 0x4a, 0x0a, 0x08, 0x4c, 0x6f, 0x67, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12,
...
var file_cluster_proto_goTypes = []any{
	(*MessageProcessedEvent)(nil),  // 0: cluster.MessageProcessedEvent
	(*Message)(nil),                // 1: cluster.Message
	(*MessageResult)(nil),          // 2: cluster.MessageResult
	(*LogEntry)(nil),               // 3: cluster.LogEntry
	(*AppendEntries)(nil),          // 4: cluster.AppendEntries
	(*AppendEntriesResult)(nil),    // 5: cluster.AppendEntriesResult
	(*RequestVote)(nil),            // 6: cluster.RequestVote
	(*RequestVoteResult)(nil),      // 7: cluster.RequestVoteResult
	(*PID)(nil),                    // 8: cluster.PID
	(*RegisterNode)(nil),           // 9: cluster.RegisterNode
	(*ActiveNodes)(nil),            // 10: cluster.ActiveNodes
	(*RegisterConsumer)(nil),       // 11: cluster.RegisterConsumer
	(*RegisterConsumerResult)(nil), // 12: cluster.RegisterConsumerResult
}
var file_cluster_proto_depIdxs = []int32{
	1, // 0: cluster.MessageProcessedEvent.message:type_name -> cluster.Message
	8, // 1: cluster.MessageResult.redirectPID:type_name -> cluster.PID
	1, // 2: cluster.LogEntry.message:type_name -> cluster.Message
	3, // 3: cluster.AppendEntries.entries:type_name -> cluster.LogEntry
	8, // 4: cluster.ActiveNodes.nodes:type_name -> cluster.PID
	8, // 5: cluster.RegisterConsumer.PID:type_name -> cluster.PID
